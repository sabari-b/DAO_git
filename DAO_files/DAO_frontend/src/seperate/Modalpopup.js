                    ...
                    <div class="modal-dialog modal-dialog-centered modal-sm">
                        <div class="modal-content custom-modal-1">
                            <div class="modal-header border-0">
                                ...
                                <button type="button" class="custom-modal-btn-1" data-bs-dismiss="modal" aria-label="Close">
                                    <IoMdClose />
                                </button>
                            </div>
                            <div class="modal-body mb-4">
                                <div className='custom-inside-modal-body'>
                                    <div className='web-site-img d-flex align-items-center justify-content-between'>
                                        <div>
                                            <GoogleOAuthProvider
                                                clientId="963401899710-f4mvvjcv1uf5jf4vbeesi95g7d5n8s0q.apps.googleusercontent.com">
                                        ...
                                        <div>
                                            {accounts.length > 0 ? (
                                                ...
                                                <p className='p-0 m-0' onClick={handleLogin}>
                                                    <img src={windows}></img>
                                                </p>
                                            )}
                                        </div>
                                        <p className='p-0 m-0' onClick={handleTwitterLogin}>
                                            <img src={twitter}></img>
                                        </p>
                                        <img src={apple} className='me-0'></img>
                                    </div>
                                    {/* <div className='text-center modal-button'>
                                        <button onClick={handleTwitterLogin} className=' mt-3'>Login</button>
                                    </div> */}
                                    <form>
                                        <div class="mb-3 mt-3">
                                            <input type="email" class="form-control modal-form" id="exampleInputEmail1"
